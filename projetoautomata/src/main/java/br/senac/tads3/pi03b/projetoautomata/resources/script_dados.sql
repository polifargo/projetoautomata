insert into produtos (id, modelo, unidade, valorvenda, valorcusto, notasinternas) values ('MEM1','pente memória 8gb dell power edge t610', 'pc', 0, 0, ' ');
insert into produtos (id, modelo, unidade, valorvenda, valorcusto, notasinternas) values ('HD01', 'hard drive 3tb sata dell power edge 190y', 'pc', 0, 0, ' ');
insert into produtos (id, modelo, unidade, valorvenda, valorcusto, notasinternas) values ('MEM2', 'memoria dimm - 64mb', 'pc', 0, 0, 'memoria dimm - 64mg');
insert into produtos (id, modelo, unidade, valorvenda, valorcusto, notasinternas) values ('MON01', 'monitor 15"', 'pc', 984.492000, 856.0800, 'monitor 15"');
insert into produtos (id, modelo, unidade, valorvenda, valorcusto, notasinternas) values ('MEM3', 'memoria dimm pc133', 'pc', 175.950000, 153, 'memoria dimm 256 pc133');
...
insert into Unidades (id, fantasia, razao, uf, cidade, logradouro, bairro, CadastroNacional) values ('ESP', 'Unidade SP', 'UNIDADE DE SÃO PAULO LTDA', 'SP', 'SÃO PAULO', 'AV PAULISTA, 2002', 'CERQUEIRA CESAR', '56259656000188');
insert into Unidades (id, fantasia, razao, uf, cidade, logradouro, bairro, CadastroNacional) values ('EPE', 'Unidade PE', 'UNIDADE DE PERNAMBUCO LTDA', 'PE', 'PERNAMBUCO', 'AV PERNAMBUCANA, 564', 'PANELAS', '56259656000269');
insert into Unidades (id, fantasia, razao, uf, cidade, logradouro, bairro, CadastroNacional) values ('ERS', 'Unidade RS', 'UNIDADE DO RIO GRANDE DO S LTDA', 'RS', 'RIO GRANDE DO S', 'AV RIO GRANDE, 22', 'FLORIPA', '56259656000340');
