 ...
 * @author mathe
 */
@WebServlet(name = "PrestacaoServicoServlet", urlPatterns = {"/prestacaoservico"})
public class PrestacaoServicoServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher dispatcher
                = request.getRequestDispatcher("/WEB-INF/jsp/realizar_prestacaoservico.jsp");
